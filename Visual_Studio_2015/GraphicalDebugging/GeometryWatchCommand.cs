...
namespace GraphicalDebugging
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class GeometryWatchCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private GeometryWatchCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static GeometryWatchCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new GeometryWatchCommand(package);
        }
